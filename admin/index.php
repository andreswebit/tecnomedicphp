...
$portal_titulo = 'Turnos · Panel Admin';
            ...
            <table id="turnosTable">
                <thead>
                    <tr>
                        ...
                        <th class="sortable" data-col="5">Hora<span class="sort-icon"></span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- DNI -->
                        <td class="dni-cell"><?= !empty($t['dni']) ? htmlspecialchars($t['dni']) : '—' ?></td>
